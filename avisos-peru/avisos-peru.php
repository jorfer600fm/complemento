...
function run_avisos_peru() {
    ...
    new AP_Emails(); // <-- LÍNEA CORREGIDA: Se eliminó el ->init()
    (new AP_Cron())->init();
 ...
 * - Instala las plantillas de correo por defecto.
 * - Refresca las reglas de reescritura para el CPT 'aviso'.
 */
 ...
 * - Limpia las tareas cron programadas.
